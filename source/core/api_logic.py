...
from source.config.graphql_common import get_ymme_graphql, vin_profile_graphql, vehicle_profile_graphql, dtcs_definition_graphql
from source.config.rest_common import get_ymme_rest, decode_vin_rest, vin_profile_rest, vehicle_profile_rest, dtcs_definition_rest
